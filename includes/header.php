      ...
      <nav>
        <ul class="nav-links">
          ...
          <?php if ($role === "learner"): ?>
            ...
            <li><a href="/Seng321/instructor/requests.php">Join Requests</a></li>
  ...
  <ul class="dropdown-menu">
    ...
    <li><a href="<?php echo $path_prefix; ?>pages/reading.php">Reading</a></li>
          ...
          <?php elseif ($role === "instructor"): ?>
            ...
            <li><a href="<?php echo $base; ?>/instructor/requests.php">Join Requests</a></li>
              <li><a href="<?php echo $path_prefix; ?>pages/assignments.php" class="<?php echo (isset($page) && $page === 'assignments') ? 'active' : ''; ?>">Assignments</a></li>
          ...
          <?php else: ?>
            ...
            <li><a href="<?php echo $base; ?>/admin/users.php" style=" color: #e692beff;">Manage Users</a></li>
            <li><a href="<?php echo $base; ?>/admin/bulk_upload.php" style=" color: #e692beff;">Bulk Upload</a></li>
            <li><a href="<?php echo $base; ?>/admin/monitor.php" style=" color: #e692beff;">System Monitoring</a></li>
